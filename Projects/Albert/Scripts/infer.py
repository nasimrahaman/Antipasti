...
class worker(mp.Process):
    ...
    def build(self):
        """Build model"""
        modelfile = imp.load_source('sierpinskinet', self.workerconfig['modelpath'])
...
class supervisor(object):
    ...
    def load(self, pad=True, normalize=True):
        ...
        # Load from H5
        datasets = {dset: fromh5(self.superconfig['datapaths'][dset], self.superconfig['h5paths'][dset]).transpose(2, 1, 0)
...
if __name__ == '__main__':
    ...
    inferconfig = args.inferconfigset
